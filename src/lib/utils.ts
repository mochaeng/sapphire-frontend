...
export const buttonClasses =
  "flex items-center justify-center gap-4 rounded-xl bg-white px-0 py-[6px] text-secondaryOnly shadow-none md:h-full md:w-full md:justify-center xl:justify-start";
